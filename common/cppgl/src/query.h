...
struct Timer {
    ...
    /**
     * If offset_ms = 2000, then an immediate look() returns 2000
     */
    inline void begin(int offset_ms){
        start_time = std::chrono::system_clock::now() - std::chrono::milliseconds(offset_ms);
    }
