...
public:
    ...
    /* Bind both the material and the vertex array object. This is what you
     * want to use most of the time. Use the second version for shaders that
     * don't require the material
     */
    void bind(const Shader& shader) const;
    // Only bind vertex array object
    void bind() const;
    void draw() const;
    void unbind() const;
